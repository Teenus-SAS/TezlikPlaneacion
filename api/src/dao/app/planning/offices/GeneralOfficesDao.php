...
class GeneralOfficesDao
{
    ...
    public function findAllActualsOfficesByCompany($id_company)
    {
        ...
        $stmt = $connection->prepare("SELECT o.id_order, o.id_client, p.reference, p.quantity, p.minimum_stock, p.accumulated_quantity, o.id_product, o.status, o.num_order, o.date_order, o.original_quantity, p.product, c.client, o.min_date, o.max_date, o.delivery_date
                                      FROM plan_orders o
    ...
    public function findAllFilterOrders($min_date, $max_date, $id_company)
    {
        ...
        $stmt = $connection->prepare("SELECT o.id_order, o.id_client, o.id_product, p.minimum_stock, o.num_order, o.status, o.date_order, o.original_quantity, p.reference, p.product, p.quantity, p.accumulated_quantity, c.client, o.min_date, o.max_date, o.delivery_date
                                      FROM plan_orders o
                                        INNER JOIN products p ON p.id_product = o.id_product
                                        INNER JOIN plan_clients c ON c.id_client = o.id_client
