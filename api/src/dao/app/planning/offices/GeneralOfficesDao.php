...
class GeneralOfficesDao
{
    ...
    public function findAllFilterOrders($min_date, $max_date, $id_company)
    {
        ...
        $stmt = $connection->prepare("SELECT o.id_order, o.id_client, o.id_product, p.minimum_stock, o.num_order, o.status, o.date_order, o.original_quantity, p.product, p.quantity, p.accumulated_quantity, c.client, o.min_date, o.max_date, o.delivery_date
                                      FROM plan_orders o
                                        INNER JOIN products p ON p.id_product = o.id_product
                                        INNER JOIN plan_clients c ON c.id_client = o.id_client
