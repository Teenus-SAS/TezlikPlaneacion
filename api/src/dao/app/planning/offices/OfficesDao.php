...
class OfficesDao
{
    ...
    public function findAllOfficesByCompany($id_company)
    {
        ...
        $stmt = $connection->prepare("SELECT o.id_order, o.id_client, o.id_product, o.status, o.num_order, o.date_order, o.original_quantity, p.product, c.client, o.min_date, o.max_date, o.delivery_date
                                      FROM plan_orders o
