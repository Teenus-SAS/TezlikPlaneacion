...
$app->get('/staffAvailable', function (Request $request, Response $response, $args) use ($dashboardGeneralDao) {
    session_start();
    $id_company = $_SESSION['id_company'];

    $staffAvailable = $dashboardGeneralDao->findStaffAvailableByCompany($id_company);
