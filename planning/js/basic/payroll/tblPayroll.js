      ...
      },
      {
        ...
        render: function (data) {
          return `<a href="javascript:;">
                    <i id="${data.id_plan_payroll}" class="${data.status == 1 ? 'bi bi-person-fill-check' : 'bi bi-person-fill-x'} statusPY" data-toggle='tooltip' title='${data.status == 0 ? 'Activar' : 'Desactivar'} empleado' style="font-size:25px; color: ${data.status == 0 ? '#ffaa00' : '#ff0000'};"></i>
                  </a>`;
        }
      },
      {
