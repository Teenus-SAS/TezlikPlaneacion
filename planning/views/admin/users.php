...
<head>
    ...
    <title>TezlikPlanner | Users</title>
                        ...
                        <div class="row align-items-center">
                            <div class="col-sm-5 col-xl-6">
                                <div class="page-title">
                                    <h3 class="mb-1 font-weight-bold text-dark"><i class="bi bi-people-fill mr-1"></i>Usuarios y <i class="fas fa-lock mr-1"></i>Accesos</h3>
                            ...
                            <div class="col-sm-7 col-xl-6 form-inline justify-content-sm-end">
                                <div class="col-xs-2 mr-2">
                                    <button class="btn btn-warning" id="btnNewUser"><i class="bi bi-person-fill-add"></i> Nuevo Usuario y Accesos</button>
                                </div>
                            </div>
                        </div>
                    </div>
