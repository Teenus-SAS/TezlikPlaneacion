                                        ...
                                        <div class="card-body">
                                            <div class="form-row">
                                                <div class="col-sm-2 floating-label enable-floating-label show-label cardSelect" style="margin-bottom:20px">
                                                    ...
                                                    <select class="form-control refMaterial selectMaterial" name="refMaterial" id="refMaterial"></select>
                                                </div>
                                                <div class="col-sm-10 floating-label enable-floating-label show-label cardSelect" style="margin-bottom:20px">
                                                    <label for="">Materia Prima</label>
                                                    <select class="form-control material selectMaterial" name="material" id="material"></select>
                                                </div>
