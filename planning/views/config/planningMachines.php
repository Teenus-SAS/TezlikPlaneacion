...
<head>
    ...
    <title>TezlikPlanner | Program Machines</title>
                        ...
                        <div class="row align-items-center">
                            <div class="col-sm-5 col-xl-6">
                                <div class="page-title">
                                    <h3 class="mb-1 font-weight-bold text-dark">Programación Máquinas y/o Procesos</h3>
                                ...
                                <form id="formImportPlanMachines" enctype="multipart/form-data">
                                    <div class="card">
                                        <div class="card-body pt-3">
                                            <div class="form-row" id="formPlanMachines">
